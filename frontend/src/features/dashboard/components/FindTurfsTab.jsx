...
import { FiSearch, FiFilter, FiMapPin, FiStar, FiClock, FiDollarSign, FiCalendar } from 'react-icons/fi';
...
const mockAvailableTurfs = [
  ...
  },
  {
    ...
    price: 1900,
    image: 'https://images.unsplash.com/photo-1579952363873-27f3bade9f55?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80',
    amenities: ['Parking', 'Changing Rooms', 'Floodlights', 'Cafeteria', 'First Aid', 'WiFi'],
    availability: {
      '2024-04-20': ['09:00', '10:00', '11:00', '14:00', '15:00', '16:00', '17:00'],
      '2024-04-21': ['09:00', '10:00', '11:00', '14:00', '15:00', '16:00']
    }
  },
  {
    ...
    availability: {
      '2024-04-20': ['10:00', '11:00', '14:00', '15:00', '16:00'],
      '2024-04-21': ['09:00', '10:00', '11:00', '14:00', '15:00', '16:00']
    }
  }
];
...
const FindTurfsTab = () => {
  ...
  const locations = useMemo(() => {
    const uniqueLocations = [...new Set(mockAvailableTurfs.map(turf => turf.location))];
    return uniqueLocations;
  }, []);

  // Get unique sports for filter
  const sports = useMemo(() => {
    const allSports = mockAvailableTurfs.flatMap(turf => turf.sports);
  ...
  const filteredTurfs = useMemo(() => {
    return mockAvailableTurfs.filter(turf => {
      // Search query filter
      const matchesSearch = 
      ...
      // Location filter
      const matchesLocation = locationFilter === 'all' || turf.location === locationFilter;
      ...
      if (priceFilter === 'low') {
        matchesPrice = turf.price <= 1500;
      } else if (priceFilter === 'medium') {
        matchesPrice = turf.price > 1500 && turf.price <= 2000;
      } else if (priceFilter === 'high') {
        matchesPrice = turf.price > 2000;
      }
      
      // Rating filter
      let matchesRating = true;
      if (ratingFilter === 'high') {
        matchesRating = turf.rating >= 4.5;
      } else if (ratingFilter === 'medium') {
        matchesRating = turf.rating >= 4.0 && turf.rating < 4.5;
      } else if (ratingFilter === 'low') {
        matchesRating = turf.rating < 4.0;
      }
      
      return matchesSearch && matchesLocation && matchesSport && matchesPrice && matchesRating;
    });
  }, [searchQuery, locationFilter, sportFilter, priceFilter, ratingFilter]);
  ...
  return (
    ...
    >
      ...
      <motion.section 
        ...
        variants={scaleIn}
      >
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Find Turfs</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            >
              ...
              <option value="medium">₹1500 - ₹2000</option>
          ...
          <div>
            ...
            >
              ...
              <option value="low">Below 4.0 Stars</option>
            </select>
          </div>
      ...
      >
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex space-x-2">
                  ...
                  <Button 
                    className="px-3 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-all duration-300"
                  >
                    <FiStar />
                  </Button>
                </div>
        ...
        {filteredTurfs.length === 0 && (
          ...
          >
            <h3 className="text-xl font-semibold text-gray-800 mb-2">No turfs found</h3>
